  ...
  if (existingBooths.length === 0) {
    ...
    await db.insert(ormawaBooths).values([
      ...
      },
      {
        ...
        badgeIcon: "Cpu",
        badgeColor: "#2563eb",
        contactPerson: "Kak Farhan (+6281233445566)",
      ...
      },
      {
        ...
        badgeIcon: "Newspaper",
        badgeColor: "#d97706",
        contactPerson: "Kak Nabila (+6285711223344)",
      ...
      },
      {
        ...
        badgeIcon: "Mountains",
        badgeColor: "#15803d",
        contactPerson: "Kak Bima (+6287766554433)",
      ...
      },
      {
        ...
        badgeIcon: "FirstAid",
        badgeColor: "#dc2626",
        contactPerson: "Kak Annisa (+6289988776655)",
      ...
      },
      {
        ...
        badgeColor: "#7c3aed",
        contactPerson: "Kak Tiara (+6282133221100)",
      ...
      },
      {
        ...
        badgeColor: "#9333ea",
        contactPerson: "Kak Dimas (+6285644332211)",
      ...
      },
      {
        ...
        badgeColor: "#0284c7",
        contactPerson: "Kak Rian (+6281809988776)",
      ...
      },
      {
        ...
        badgeIcon: "Moon",
        badgeColor: "#059669",
        contactPerson: "Kak Habib (+6287811223399)",
